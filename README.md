...
- In addition to the game port itself, verify related SourceTV/client/Steam-LAN ports (defaults in this repo: `27020/udp`, `27005/udp`, `26900/udp`) against current CS2/Valve server documentation before exposing ports.
