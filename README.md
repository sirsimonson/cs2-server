...
- If you run non-default or custom CS2 networking settings, verify and expose any related SourceTV/client/Steam-LAN ports according to current CS2/Valve server documentation.
